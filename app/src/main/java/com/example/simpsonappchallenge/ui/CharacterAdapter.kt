...
class CharacterAdapter(
    private val simpsonsCharacterList: List<SimpsonSimpleCharacter.DataSimple>,
    private val onClickListener: (SimpsonSimpleCharacter.DataSimple, Boolean) -> Unit,
) : RecyclerView.Adapter<CharacterAdapter.SimpsonHolder>() {

    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): CharacterAdapter.SimpsonHolder {
